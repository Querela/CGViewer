...
void Octree::buildRec(std::vector<Triangle *> *triangles, std::vector<Voxel *> *voxels, Vector *ldown, Vector *rtop, int depth)
{
    ...
    //voxel 1
    vox.push_back(new Voxel(new Vector(middle[0], (*ldown)[1], (*ldown)[2]),
                            new Vector((*rtop)[0], middle[1], middle[2]), &normx, &normy, &normz));
    //voxel 2
    vox.push_back(new Voxel(new Vector((*ldown)[0], middle[1], (*ldown)[2]),
                            new Vector(middle[0], (*rtop)[1], middle[2]), &normx, &normy, &normz));
    //voxel 3
    vox.push_back(new Voxel(new Vector(middle[0], middle[1], (*ldown)[2]),
                            new Vector((*rtop)[0], (*rtop)[1], middle[2]), &normx, &normy, &normz));
    //voxel 4
    vox.push_back(new Voxel(new Vector((*ldown)[0], (*ldown)[1], middle[2]),
                            new Vector(middle[0], middle[1], (*rtop)[2]), &normx, &normy, &normz));
    //voxel 5
    vox.push_back(new Voxel(new Vector(middle[0], (*ldown)[1], middle[2]),
                            new Vector((*rtop)[0], middle[1], (*rtop)[2]), &normx, &normy, &normz));
    //voxel 6
    vox.push_back(new Voxel(new Vector((*ldown)[0], middle[1], middle[2]),
                            new Vector(middle[0], (*rtop)[1], (*rtop)[2]), &normx, &normy, &normz));
    //voxel 7
